#ifndef __STAMNOS_BCS_COMMON_MACROS_H
#define __STAMNOS_BCS_COMMON_MACROS_H

// TODO: drop these macros. they don't seem to be quite helpful.
...
#define RPC_REGISTER_HANDLER(rpcs)                                                                 \
    ...
    void reg(unsigned int proc, S* sob, int (S::*meth)(const A1 a1, const A2, R& r))               \
    {                                                                                              \
        rpcs->reg(proc, sob, meth);                                                                \
    }                                                                                              \
                                                                                                   \
    template <class S, class A1, class A2, class A3, class R>                                      \
    void reg(unsigned int proc, S* sob, int (S::*meth)(const A1, const A2, const A3, R& r))        \
    {                                                                                              \
        rpcs->reg(proc, sob, meth);                                                                \
    }                                                                                              \
                                                                                                   \
...
#define RPCFAST_CALL(RPCC)                                                                         \
    ...
    int call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,            \
             const A5& a5, R& r)                                                                   \
    {                                                                                              \
        return RPCC->call(proc, a1, a2, a3, a4, a5, r);                                            \
    }                                                                                              \
                                                                                                   \
    template <class R, class A1, class A2, class A3, class A4, class A5, class A6>                 \
    int call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,            \
    ...
    {                                                                                              \
        return RPCC->call(proc, a1, a2, a3, a4, a5, a6, r);                                        \
    }                                                                                              \
                                                                                                   \
    template <class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7>       \
    int call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,            \

...
#/scratch/nvm/stamnos/libfs/build/src/pxfs/tool/pxfs create -p /tmp/stamnos_pool -s 4096M -t mfs
/scratch/nvm/stamnos/libfs/build/src/pxfs/tool/pxfs create -p /tmp/stamnos_pool -s 6144M -t mfs
...
#gdb --args /scratch/nvm/stamnos/libfs/build/src/scm/tool/pool/pool create -p /tmp/stamnos_pool -s 16M

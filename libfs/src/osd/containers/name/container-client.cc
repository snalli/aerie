...
int NameContainer::VersionManager::return_dentry(void* dentry_list_head_addr)
{
...
int NameContainer::VersionManager::vOpen()
{
...
int NameContainer::VersionManager::vUpdate(OsdSession* session)
{
...
int NameContainer::VersionManager::Find(OsdSession* session, const char* name,
                                        osd::common::ObjectId* oidp, void* /*ip*/)
{
    int ret;
...
// already exists
int NameContainer::VersionManager::Insert(OsdSession* /*session*/, const char* name,
                                          osd::common::ObjectId oid, void* ip)
{
    ShadowCache::iterator it;
    osd::common::ObjectId tmp_oid;
    Shadow entry;
...
int NameContainer::VersionManager::Erase(OsdSession* session, const char* name)
{
    ShadowCache::iterator it;
...
int NameContainer::VersionManager::Size(OsdSession* session)
{

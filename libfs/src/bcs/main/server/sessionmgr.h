...
int BaseSessionManager::Lookup(int clt, BaseSession** session)
{
...
int BaseSessionManager::Insert(int clt, BaseSession* session)
{
    clt_session_map_[clt] = session;
    return E_SUCCESS;
}

int BaseSessionManager::Remove(int clt)
{
    ClientSessionMap::iterator it;

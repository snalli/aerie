...
#ifndef __STAMNOS_OSD_COMMON_NAME_COLLECTION_OBJECT_H
#define __STAMNOS_OSD_COMMON_NAME_COLLECTION_OBJECT_H

#include <stdio.h>
#include <stdint.h>
#include <typeinfo>
#include "osd/containers/name_collection/hashtable.h"
...
public:
	...
	int Find(Session* session, const char* name, osd::common::Object oid);
...
#endif // __STAMNOS_OSD_COMMON_NAME_COLLECTION_H

...
class FileSystemObjectManager
{
  ...
  public:
    ...
    void Register(int type_id, const char* type_str, SuperBlockFactory* sb_factory,
    ...
    int LoadSuperBlock(Session* session, osd::common::ObjectId oid, const char* fs_type,
                       SuperBlock** sbp);

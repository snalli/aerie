...
class NeedleContainer
{
  public:
    template <typename Session> class Object : public osd::cc::common::Object
    {
        ...
        {
            kNeedleSize =
                (64 + 16) * 1024 // be careful to not overflow (sizeof(enum) = sizeof(int))
        };
...
template <typename Session> NeedleContainer::Object<Session>::Object() : size_(0)
{
    set_type(T_NEEDLE_CONTAINER);
}

template <typename Session>
int NeedleContainer::Object<Session>::Write(Session* /*session*/, const char* src, uint64_t /*off*/,
                                            uint64_t n)
{
...
template <typename Session>
int NeedleContainer::Object<Session>::Read(Session* /*session*/, char* dst, uint64_t /*off*/,
                                           uint64_t n)
{

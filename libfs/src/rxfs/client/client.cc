...
int Client::Open(const char* path, int flags, int /*mode*/, File** file)
{
    PROFILER_PREAMBLE
    int ret;
    File* fp;
...
int Client::WriteOffset(File* fp, const char* src, uint64_t n, uint64_t offset)
{
...
int Client::ReadOffset(File* fp, char* dst, uint64_t n, uint64_t offset)
{
...
int Client::Write(File* fp, const char* src, uint64_t n)
{
...
int Client::Read(File* fp, char* dst, uint64_t n)
{

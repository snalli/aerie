...
template <typename Session, typename StorageSystem> class SessionManager
{
  public:
...
int SessionManager<Session, StorageSystem>::Init()
{
...
template <typename Session, typename StorageSystem>
int SessionManager<Session, StorageSystem>::Create(int clt, Session** sessionp)
{
    int ret;

...
uint32_t lock_protocol::MODE::hierarchy_rule_bitmaps_[] = {
	/* NL   */  BITMAP_SET(lock_protocol::NL) | 
	            BITMAP_SET(lock_protocol::SL) |
	            BITMAP_SET(lock_protocol::SR) |
	            BITMAP_SET(lock_protocol::IS) | 
	            BITMAP_SET(lock_protocol::IX) | 
	            BITMAP_SET(lock_protocol::XL) | 
	            BITMAP_SET(lock_protocol::XR) | 
	            BITMAP_SET(lock_protocol::IXSL),

	/* SL   */  BITMAP_SET(lock_protocol::IS) | 
	            BITMAP_SET(lock_protocol::SR) |
	            BITMAP_SET(lock_protocol::IX) |
	            BITMAP_SET(lock_protocol::XR),

	/* SR   */  BITMAP_SET(lock_protocol::IS) | 
	            BITMAP_SET(lock_protocol::IX) |
	            BITMAP_SET(lock_protocol::SR),

	/* IS   */  BITMAP_SET(lock_protocol::IS) | 
	            BITMAP_SET(lock_protocol::SR),
	
	/* IX   */  BITMAP_SET(lock_protocol::IS) | 
	            BITMAP_SET(lock_protocol::IX),

	/* XL   */  BITMAP_SET(lock_protocol::IX) | 
	            BITMAP_SET(lock_protocol::XR) |
	            BITMAP_SET(lock_protocol::IXSL),
	
	/* XR   */  BITMAP_SET(lock_protocol::IX) |
	            BITMAP_SET(lock_protocol::IXSL) | 
	            BITMAP_SET(lock_protocol::XR),

	/* IXSL */  BITMAP_SET(lock_protocol::IX) | 
	            BITMAP_SET(lock_protocol::IXSL) |
	            BITMAP_SET(lock_protocol::XR)
};
...
uint32_t lock_protocol::MODE::recursive_rule_bitmaps_[] = {
	...
	/* SL   */ BITMAP_SET(lock_protocol::SR) |
	           BITMAP_SET(lock_protocol::XR),

	/* SR   */ BITMAP_SET(lock_protocol::SR),

	/* IS   */ BITMAP_SET(lock_protocol::SR) |
	           BITMAP_SET(lock_protocol::XR),
	
	/* IX   */ BITMAP_SET(lock_protocol::XR),

	/* XL   */ BITMAP_SET(lock_protocol::XR),

	/* XR   */ BITMAP_SET(lock_protocol::XR),
	
	/* IXSL */ BITMAP_SET(lock_protocol::XR)
};

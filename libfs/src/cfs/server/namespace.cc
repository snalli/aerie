...
int NameSpace::Nameiparent(Session* session, const char* path, char* name, InodeNumber* ino)
{
    int ret;
...
int NameSpace::Namei(Session* session, const char* path, InodeNumber* ino)
{
    int ret;
    char name[128];

...
#ifndef __STAMNOS_SSA_CLIENT_HIERARCHICAL_LOCK_MANAGER_H
#define __STAMNOS_SSA_CLIENT_HIERARCHICAL_LOCK_MANAGER_H
...
namespace client {
	typedef ::ssa::cc::client::HLock         HLock;
	typedef ::ssa::cc::client::HLockManager  HLockManager;
	typedef ::ssa::cc::client::HLockCallback HLockCallback;
} // namespace client


#endif // __STAMNOS_SSA_CLIENT_HIERARCHICAL_LOCK_MANAGER_H

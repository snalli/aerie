  ...
  public:
    template <typename Session> class Object : public osd::cc::common::Object
    {
      public:
        ...
        Object() : root_(osd::common::ObjectId(0)), freelist_(osd::common::ObjectId(0))
        {
...
osd::common::ObjectId SuperContainer::Object<Session>::root(Session* /*session*/)
{
    return root_;
}

template <typename Session>
void SuperContainer::Object<Session>::set_root(Session* /*session*/, osd::common::ObjectId oid)
{
    root_ = oid;
}

template <typename Session>
osd::common::ObjectId SuperContainer::Object<Session>::freelist(Session* /*session*/)
{
    return freelist_;
}

template <typename Session>
void SuperContainer::Object<Session>::set_freelist(Session* /*session*/, osd::common::ObjectId oid)
{
    freelist_ = oid;
}

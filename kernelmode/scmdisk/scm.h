...
int scm_global_init(void);
void scm_global_fini(void);
int scm_init(scm_t **);
void scm_fini(scm_t *);
int scm_storeset_create(scm_t *scm, scm_storeset_t **setp);
void scm_storeset_destroy(scm_storeset_t *set);
int scm_check_crash(scm_t *scm);
void scm_trigger_crash(scm_t *scm);
void scm_trigger_crash_reset(scm_t *scm);
void scm_wb_store_emulate_crash(scm_storeset_t *set, volatile scm_word_t *addr, scm_word_t val);
void scm_wb_flush_emulate_crash(scm_storeset_t *set, volatile scm_word_t *addr);
void scm_nt_store_emulate_crash(scm_storeset_t *set, volatile scm_word_t *addr, scm_word_t val);
void scm_nt_flush_emulate_crash(scm_storeset_t *set);

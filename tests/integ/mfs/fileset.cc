...
int FileSet::Create(const char* root, int dirwidth, int dirdepth, int dirfanout, FileSet* fileset)
{
    std::string filename;
    char buf[1024];
...
int FileSet::Copy(int n, FileSet* dst)
{
    std::string filename;
...
int FileSet::MoveRandom(int n, FileSet* dst)
{
    std::string filename;

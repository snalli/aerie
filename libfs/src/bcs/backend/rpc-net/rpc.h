...
class rpcc : public chanmgr
{
  ...
  public:
    ...
    template <class R> int call_m(unsigned int proc, marshall& req, R& r, TO to);

    template <class R> int call(unsigned int proc, R& r, TO to = to_max);
    template <class R, class A1> int call(unsigned int proc, const A1& a1, R& r, TO to = to_max);
    ...
    int call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,
             const A5& a5, R& r, TO to = to_max);
    template <class R, class A1, class A2, class A3, class A4, class A5, class A6>
    int call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,
             const A5& a5, const A6& a6, R& r, TO to = to_max);
    template <class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
    int call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,
             const A5& a5, const A6& a6, const A7& a7, R& r, TO to = to_max);
};

template <class R> int rpcc::call_m(unsigned int proc, marshall& req, R& r, TO to)
{
    unmarshall u;
...
template <class R, class A1, class A2, class A3>
int rpcc::call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, R& r, TO to)
{
    marshall m;
    m << a1;
    m << a2;
...
template <class R, class A1, class A2, class A3, class A4, class A5, class A6>
int rpcc::call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,
               const A5& a5, const A6& a6, R& r, TO to)
{
    marshall m;
    m << a1;
    m << a2;
...
template <class R, class A1, class A2, class A3, class A4, class A5, class A6, class A7>
int rpcc::call(unsigned int proc, const A1& a1, const A2& a2, const A3& a3, const A4& a4,
               const A5& a5, const A6& a6, const A7& a7, R& r, TO to)
{
    marshall m;
    m << a1;
    m << a2;

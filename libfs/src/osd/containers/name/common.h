  ...
  public:
    template <typename Session> class Object : public osd::cc::common::Object
    {
      public:
        ...
        Object() : self_(osd::common::ObjectId(0))
        {
      ...
      private:
        ...
        { // insight : defined in hashtable-linear.h
            return &ht_;
        }
...
template <typename Session> int NameContainer::Object<Session>::return_dentry(void* head_addr)
{
...
int NameContainer::Object<Session>::Find(Session* session, const char* name,
                                         osd::common::ObjectId* oid)
{
    uint64_t u64;
    int ret;
...
template <typename Session>
int NameContainer::Object<Session>::Insert(Session* session, const char* name,
                                           osd::common::ObjectId oid)
{
    uint64_t u64;
...
template <typename Session>
int NameContainer::Object<Session>::Erase(Session* session, const char* name)
{
    if (name[0] == '\0')
    {
        return -1;
...
template <typename Session> int NameContainer::Object<Session>::Size(Session* session)
{
    int size = 0;

...
class NameSpace
{
  ...
  public:
    ...
    int namei_sans_locks(Session* session, const char* path, lock_protocol::Mode lock_mode,
                         Inode**);
    int Nameiparent(Session* session, const char* path, lock_protocol::Mode lock_mode, char* name,
                    Inode**);
  ...
  private:
    ...
    int Namex(Session* session, const char* path, lock_protocol::Mode lock_mode, bool nameiparent,
              char* name, Inode**);
    int namex_sans_locks(Session* session, const char* path, lock_protocol::Mode lock_mode,
                         bool nameiparent, char* name, Inode**);

...
{
    BaseMessage(char type = 0) : type_(type)
    {
    }
...
template <typename T> struct Publisher::Message::BaseMessageT : public BaseMessage
{
    BaseMessageT(char type = 0) : BaseMessage(type)
    {
    }
...
{
    TransactionBegin(int id = 0) : BaseMessageT<TransactionBegin>(kTransactionBegin), id_(id)
    {
    }
...
{
    TransactionCommit() : BaseMessageT<TransactionCommit>(kTransactionCommit)
    {
    }
};
...
struct Publisher::Message::LogicalOperationHeader : public BaseMessageT<LogicalOperationHeader>
{
    LogicalOperationHeader(char id, size_t total_size)
        : BaseMessageT<LogicalOperationHeader>(kLogicalOperation), id_(id),
...
{
    LogicalOperationHeaderT(char id, size_t total_size) : LogicalOperationHeader(id, total_size)
    {
    }
...
struct Publisher::Message::ContainerOperationHeader : public BaseMessageT<ContainerOperationHeader>
{
    ContainerOperationHeader(char id, short total_size)
        : BaseMessageT<ContainerOperationHeader>(kContainerOperation), id_(id),
...
struct Publisher::Message::LogicalOperation::AllocContainer
    : public osd::Publisher::Message::LogicalOperationHeaderT<AllocContainer>
{
    AllocContainer(int capability, osd::common::ObjectId oid, int index_hint)
        : osd::Publisher::Message::LogicalOperationHeaderT<AllocContainer>(kAllocContainer,
                                                                           sizeof(AllocContainer)),
          capability_(capability), index_hint_(index_hint), oid_(oid)
    {
    }
...
struct Publisher::Message::ContainerOperation::AllocateExtent : public ContainerOperationHeader
{
    AllocateExtent(int capability, osd::common::ExtentId eid, int index_hint)
        : ContainerOperationHeader(kAllocateExtent, sizeof(AllocateExtent)),
          capability_(capability), index_hint_(index_hint), eid_(eid)
    {
    }
...
struct Publisher::Message::ContainerOperation::LinkBlock : public ContainerOperationHeader
{
    LinkBlock(osd::common::ObjectId oid, uint64_t bn, void* ptr)
        : ContainerOperationHeader(kLinkBlock, sizeof(LinkBlock)), oid_(oid), bn_(bn), ptr_(ptr)
    {
    }
...
struct Publisher::Message::ContainerOperation::LockCertificate : public ContainerOperationHeader
{
    LockCertificate(int nlocks)
        : ContainerOperationHeader(kLockCertificate, sizeof(LockCertificate) +
                                                         nlocks * sizeof(osd::cc::common::LockId))
    {
    }

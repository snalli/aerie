...
gnome-terminal --geometry=140x15+0-400 -x bash -c "$GDB./build/test/interactive/namespace/namespace -h 10000 -i 1 -t C1 -d $DEBUG_LEVEL; $WAITKEY" &
gnome-terminal --geometry=140x15+0-100 -x bash -c "$GDB./build/test/interactive/namespace/namespace -h 10000 -i 2 -t C2 -d $DEBUG_LEVEL; $WAITKEY"
#pkill -9 fsclient
#pkill -9 fsserver

...
/* Define to 1 if you have the `tecla' library (-ltecla). */
/* #undef HAVE_LIBTECLA */
...
/* Define if you have procfs with PIS/lwp dir */
/* #undef HAVE_PROC_PID_LWP */

/* checking if you have /proc/<pid>/stat */
...
#define PACKAGE_STRING "filebench 1.4.9.1"

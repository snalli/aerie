...
class PersistentHeap
{
  public:
    ...
    PersistentHeap(PersistentRegion* pregion, Header* header) : pregion_(pregion), header_(header)
    {
    }

    static int Open(const char* filename, size_t maxsize, PersistentHeap* allocatorp, int flags,
...
struct PersistentHeap::Header
{
  public:
    ...
    void set_vistaheap(VistaHeap* vhp)
    {
        vistaheap_ = vhp;
    }
...
int PersistentHeap::Alloc(size_t size, void** pp)
{
    void* p;
...
void PersistentHeap::Free(void* p, size_t size)
{

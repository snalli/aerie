...
#include "test/integration/ipc/ipc.handlers.h"


const char*            pathname = "/tmp/stamnos_pool"; // hardcoded; used by tests
int                    port;
pthread_attr_t         attr;
...
main(int argc, char *argv[])
{
	...
	assert(IpcTestHandlers::Register(server::Server::Instance()->ipc_layer()) == E_SUCCESS);

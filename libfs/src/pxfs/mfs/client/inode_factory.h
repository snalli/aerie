...
class InodeFactory : public ::client::InodeFactory
{
  public:
    ...
    static int LoadInode(::client::Session* session, osd::common::ObjectId oid,
                         ::client::Inode** ipp);
    static int DestroyInode(::client::Session* session, ::client::Inode* ip);
    static int LoadDirInode(::client::Session* session, osd::common::ObjectId oid,
                            ::client::Inode** ipp);
    static int LoadFileInode(::client::Session* session, osd::common::ObjectId oid,
                             ::client::Inode** ipp);

...
#define __STAMNOS_OSD_LOCK_PROTOCOL_STATIC_H
...
uint32_t lock_protocol::Mode::hierarchy_rule_bitmaps_[] = {
    /* NL   */ BITMAP_SET(lock_protocol::Mode::NL) | BITMAP_SET(lock_protocol::Mode::SL) |
        BITMAP_SET(lock_protocol::Mode::SR) | BITMAP_SET(lock_protocol::Mode::IS) |
        BITMAP_SET(lock_protocol::Mode::IX) | BITMAP_SET(lock_protocol::Mode::XL) |
        BITMAP_SET(lock_protocol::Mode::XR) | BITMAP_SET(lock_protocol::Mode::IXSL),

    /* SL   */ BITMAP_SET(lock_protocol::Mode::IS) | BITMAP_SET(lock_protocol::Mode::SR) |
        BITMAP_SET(lock_protocol::Mode::IX) | BITMAP_SET(lock_protocol::Mode::XR),

    /* SR   */ BITMAP_SET(lock_protocol::Mode::IS) | BITMAP_SET(lock_protocol::Mode::IX) |
        BITMAP_SET(lock_protocol::Mode::SR),

    /* IS   */ BITMAP_SET(lock_protocol::Mode::IS) | BITMAP_SET(lock_protocol::Mode::SR),

    /* IX   */ BITMAP_SET(lock_protocol::Mode::IS) | BITMAP_SET(lock_protocol::Mode::IX),

    /* XL   */ BITMAP_SET(lock_protocol::Mode::IX) | BITMAP_SET(lock_protocol::Mode::XL) |
        BITMAP_SET(lock_protocol::Mode::XR) | BITMAP_SET(lock_protocol::Mode::IXSL),

    /* XR   */ BITMAP_SET(lock_protocol::Mode::IX) | BITMAP_SET(lock_protocol::Mode::IXSL) |
        BITMAP_SET(lock_protocol::Mode::XR),

    /* IXSL */ BITMAP_SET(lock_protocol::Mode::IX) | BITMAP_SET(lock_protocol::Mode::IXSL) |
        BITMAP_SET(lock_protocol::Mode::XR)};

uint32_t lock_protocol::Mode::recursive_rule_bitmaps_[] = {
    /* NL   */ BITMAP_SET(lock_protocol::Mode::NL) | BITMAP_SET(lock_protocol::Mode::SR) |
        BITMAP_SET(lock_protocol::Mode::XR),

    /* SL   */ BITMAP_SET(lock_protocol::Mode::SR) | BITMAP_SET(lock_protocol::Mode::XR),

    /* SR   */ BITMAP_SET(lock_protocol::Mode::SR),

    /* IS   */ BITMAP_SET(lock_protocol::Mode::SR) | BITMAP_SET(lock_protocol::Mode::XR),
...
std::string lock_protocol::Mode::mode2str_table_[] = {"NL", "SL", "SR", "IS",
                                                      "IX", "XL", "XR", "IXSL"};

#endif // __STAMNOS_OSD_LOCK_PROTOCOL_STATIC_H

...
typedef int (*ActionFunction)(osd::server::OsdSession* session, char* buf,
                              osd::Publisher::Message::ContainerOperationHeader*);

template <typename T, typename A>
int Action(osd::server::OsdSession* session, char* buf,
  ...
  public:
    ...
    struct LockCertificate
    {
        static int Action(osd::server::OsdSession* /*session*/,
                          osd::Publisher::Message::ContainerOperation::LockCertificate* /*msg*/)
        {
            return E_SUCCESS;
        }
    };
...
int Verifier::Parse(::osd::server::OsdSession* session,

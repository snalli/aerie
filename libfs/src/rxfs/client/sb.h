...
class SuperBlock
{
  public:
    ...
    {
        osd::containers::client::SuperContainer::Object* obj =
            osd::containers::client::SuperContainer::Object::Load(oid);
    ...
    SuperBlock(osd::containers::client::SuperContainer::Object* super_obj) : super_obj_(super_obj)
    {

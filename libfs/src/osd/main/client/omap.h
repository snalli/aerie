...
class __object_map
{
    ...
    typedef google::dense_hash_map<ObjectId, ObjectProxy*, osd::common::ObjectIdHashFcn>
        ObjectIdMap;
  ...
  public:
    ...
    iterator begin()
    {
        return oid2obj_map_.begin();
    }
    iterator end()
    {
        return oid2obj_map_.end();
    }
...
inline int ObjectMap::Lookup(ObjectId oid, ObjectProxy** obj)
{
    int index;
    index = oid.u64() % N_MAP;
...
inline int ObjectMap::Insert(ObjectProxy** __proxy)
{
...
inline int ObjectMap::Remove(ObjectId oid)
{

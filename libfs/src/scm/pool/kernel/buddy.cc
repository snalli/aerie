 ...
 */
static const char *clearCheck(struct PoolInfo *pi, size_t firstBit,
    size_t pastBit)
{
...
static const char *poolBuddyAllocSize(struct PoolInfo *pi,
...
const char *poolRealloc(struct PoolInfo *pi, void *ptrv, size_t size,
    void **newPtr)
{
    int canBits;
    size_t blockNo;

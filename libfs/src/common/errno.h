...
enum
{
    __DEFINE_ERRNO(__ENUM_MEMBER) E_MAXERRNO
};
...
static inline const char* ErrorToString(int err)
{
    static const char* errstr[] = {__DEFINE_ERRNO(__ERRNO_STRING) "Unknown error code"};

...
int FileManager::AllocFile(Session* /*session*/, File** fpp)
{
...
int FileManager::ReleaseFile(Session* /*session*/, File* fp)
{
    fp->Release();
...
int FileManager::Put(Session* session, int fd)
{
    File* fp;

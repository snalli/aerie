...
class Publisher
{
  public:
    ...
    static int MakeFile(::osd::server::OsdSession* session, char* lgc_op_hdr,
                        ::osd::Publisher::Message::BaseMessage* next);
    static int MakeDir(::osd::server::OsdSession* session, char* lgc_op_hdr,
                       ::osd::Publisher::Message::BaseMessage* next);
    static int Link(::osd::server::OsdSession* session, char* lgc_op_hdr,
                    ::osd::Publisher::Message::BaseMessage* next);
    static int Unlink(::osd::server::OsdSession* session, char* lgc_op_hdr,
                      ::osd::Publisher::Message::BaseMessage* next);
    static int Write(::osd::server::OsdSession* session, char* lgc_op_hdr,
                     ::osd::Publisher::Message::BaseMessage* next);

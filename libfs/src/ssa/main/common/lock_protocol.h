...
#ifndef __STAMNOS_SSA_LOCK_PROTOCOL_H
#define __STAMNOS_SSA_LOCK_PROTOCOL_H
...
#include "ssa/main/common/lock_protocol-inl.h"

#endif // __STAMNOS_SSA_LOCK_PROTOCOL_H

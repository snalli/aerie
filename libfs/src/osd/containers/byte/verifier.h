...
static inline int Protect(unsigned long extent_base, size_t extent_size, uid_t uid, int rw)
{
    KernelExtent e;
    user_file_rights r;
...
class WriteVerifier : public Verifier
{
  public:
    ...
    {
        static int Action(osd::server::OsdSession* session,
                          osd::Publisher::Message::ContainerOperation::AllocateExtent* msg)
        {
    ...
    {
        static int Action(osd::server::OsdSession* session,
                          osd::Publisher::Message::ContainerOperation::LinkBlock* msg)
        {
            osd::common::ObjectId& oid = msg->oid_;
            osd::containers::server::ByteContainer::Object* object =
                osd::containers::server::ByteContainer::Object::Load(oid);

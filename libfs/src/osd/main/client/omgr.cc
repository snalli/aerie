 ...
 */
ObjectManager::ObjectManager(osd::client::StorageSystem* stsystem) : stsystem_(stsystem)
{
...
int ObjectManager::RegisterBaseTypes()
{
    int ret;

    // SuperContainer
    {
        osd::client::rw::ObjectManager<osd::containers::client::SuperContainer::Object,
                                       osd::containers::client::SuperContainer::VersionManager>*
            mgr = new osd::client::rw::ObjectManager<
                osd::containers::client::SuperContainer::Object,
                osd::containers::client::SuperContainer::VersionManager>;
    ...
    {
        // NameContainer
        osd::client::rw::ObjectManager<osd::containers::client::NameContainer::Object,
                                       osd::containers::client::NameContainer::VersionManager>*
            mgr = new osd::client::rw::ObjectManager<
                osd::containers::client::NameContainer::Object,
                osd::containers::client::NameContainer::VersionManager>;
    ...
    {
        // ByteContainer
        osd::client::rw::ObjectManager<osd::containers::client::ByteContainer::Object,
                                       osd::containers::client::ByteContainer::VersionManager>*
            mgr = new osd::client::rw::ObjectManager<
                osd::containers::client::ByteContainer::Object,
                osd::containers::client::ByteContainer::VersionManager>;
    ...
    {
        // NeedleContainer
        osd::client::rw::ObjectManager<osd::containers::client::NeedleContainer::Object,
                                       osd::containers::client::NeedleContainer::VersionManager>*
            mgr = new osd::client::rw::ObjectManager<
                osd::containers::client::NeedleContainer::Object,
                osd::containers::client::NeedleContainer::VersionManager>;
...
int ObjectManager::RegisterType(ObjectType type_id, ObjectManagerOfType* mgr)
{
    int ret = E_SUCCESS;
 ...
 */
int ObjectManager::GetObjectInternal(OsdSession* /*session*/, ObjectId oid,
                                     ...
                                     bool /*use_exist_obj_ref*/)
{
    ...
    DBG_LOG(DBG_INFO, DBG_MODULE(client_omgr), "[%d] Object: oid=%lx, type=%d\n", id(), oid.u64(),
            oid.type());
 ...
 *
 */
int ObjectManager::FindObject(OsdSession* session, ObjectId oid,
 ...
 *
 */
int ObjectManager::GetObject(OsdSession* session, ObjectId oid,
                             osd::common::ObjectProxyReference** obj_ref)
{
    DBG_LOG(DBG_INFO, DBG_MODULE(client_omgr), "[%d] Object: oid=%lx, type=%d\n", id(), oid.u64(),
            oid.type());
...
int ObjectManager::PutObject(OsdSession* /*session*/, osd::common::ObjectProxyReference& obj_ref)
{
    int ret = E_SUCCESS;
...
int ObjectManager::CloseObject(OsdSession* session, ObjectId oid, bool update)
{
    int ret = E_SUCCESS;
    ObjectManagerOfType* mgr;
 ...
 */
void ObjectManager::OnRelease(osd::cc::client::HLock* hlock)
{
 ...
 */
void ObjectManager::OnConvert(osd::cc::client::HLock* hlock)
{
    ObjectId oid(reinterpret_cast<uint64_t>(hlock->payload()));
 ...
 */
void ObjectManager::OnRelease(osd::cc::client::Lock* lock)
{
 ...
 */
void ObjectManager::OnConvert(osd::cc::client::Lock* lock)
{
    ObjectId oid(reinterpret_cast<uint64_t>(lock->payload()));
...
void ObjectManager::PreDowngrade()
{

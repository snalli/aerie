#ifndef __STAMNOS_CFS_COMMON_PUBLISHER_H
#define __STAMNOS_CFS_COMMON_PUBLISHER_H
...
struct Publisher::Message::LogicalOperation::Write
    : public osd::Publisher::Message::LogicalOperationHeaderT<Write>
{
    Write(InodeNumber ino)
        : osd::Publisher::Message::LogicalOperationHeaderT<Write>(kWrite, sizeof(Write)), ino_(ino)
    {
    }
...
struct Publisher::Message::LogicalOperation::MakeFile
    : public osd::Publisher::Message::LogicalOperationHeaderT<MakeFile>
{
    MakeFile(InodeNumber parino, const char* name, InodeNumber childino)
        : osd::Publisher::Message::LogicalOperationHeaderT<MakeFile>(kMakeFile, sizeof(MakeFile)),
          parino_(parino), childino_(childino)
    {
        strcpy(name_, name);
    }
...
struct Publisher::Message::LogicalOperation::MakeDir
    : public osd::Publisher::Message::LogicalOperationHeaderT<MakeDir>
{
...
struct Publisher::Message::LogicalOperation::Link
    : public osd::Publisher::Message::LogicalOperationHeaderT<Link>
{
...
struct Publisher::Message::LogicalOperation::Unlink
    : public osd::Publisher::Message::LogicalOperationHeaderT<Unlink>
{
...
#endif // __STAMNOS_CFS_COMMON_PUBLISHER_H

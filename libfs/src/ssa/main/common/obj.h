 ...
 * concurrency control
 */
class Object: public ssa::common::Object {
public:
	Object()
		: status_(0),
		  version_(0)
...
inline marshall& operator<<(marshall &m, ::ssa::common::ObjectId oid) {
	m << (unsigned long long) oid.u64();
	return m;
}


inline unmarshall& operator>>(unmarshall &u, ::ssa::common::ObjectId& oid) {

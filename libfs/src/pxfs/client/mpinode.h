...
{ // MPInode : Mount point Inode
  public:
    MPInode() : entries_count_(0)
    {
    ...
    int xLookup(Session* /*session*/, const char* /*name*/, int /*flags*/, Inode** /*inode*/)
    {
        return 0;
    }
  ...
  private:
    Inode* parent_;
    Entry entries_[MAX_NUM_ENTRIES]; // insight : Only 3 files per directory !!!!!!!!!!!!!!!!!! wtf
                                     // HARISSSSSSS aarrgh !!!!!!!!!11

...
def addIntegrationTests(env, parent_dir, testProgram, serverProgram):
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockUnlockSingle',
    ...
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockUnlockConcurrent1',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 
            'C1': ( testProgram, [('T1', 'Lock:TestLockUnlock')]),
    ...
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockUnlockMultipleTimesConcurrent1',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 
    ...
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockUnlockMultipleTimesConcurrent2',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 
            'C1': ( testProgram, [('T1', 'Lock:TestLockUnlockMultipleTimes')]),
    ...
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockUnlockMultipleTimesConcurrent3',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 
    ...
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockConvert1',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 
    ...
    # a second client tries to acquire the lock in SL between the two events 
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestLockConvert2',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 
    ...
    env.addIntegrationTest(testfw.integration_test.IntegrationTest(
        name = 'OSD_Lock:TestSharedLockUnlockConcurrentClients1',
        init_script = os.path.join(parent_dir, 'test/integration/init.sh'),
        testfw = testProgram, server = serverProgram,
        clients = { 

...
#ifndef __STAMNOS_IPC_SERVER_SESSION_MANAGER_H
#define __STAMNOS_IPC_SERVER_SESSION_MANAGER_H
 ...
 * that lives in the IPC layer (bottom layer) and a top-layer session manager 
...
#endif // __STAMNOS_IPC_SERVER_SESSION_MANAGER_H
